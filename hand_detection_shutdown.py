...
def mover_ventana_derecha():
    ...
    # Es necesario mantener presionadas las teclas Windows y Shift mientras se
    # pulsa la flecha para que el sistema no interprete un "Win+Right" (que
    # muestra las opciones de ajuste).
    keyboard.press('windows')
